...
#[derive(Debug)]
pub struct EmberHingeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EmberHingeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EmberHinge processing");
    
    let mut processor = EmberHingeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EmberHingeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EmberHingeProcessor::new(false);
